...
Start-Process -Wait -NoNewWindow "${GitHubActionsRunnerPath}\bin\Runner.Listener.exe" "configure --unattended --runasservice --labels ${GithubActionsRunnerLabels} --url ${GitHubActionsRunnerRepo} --token ${GitHubActionsRunnerToken}"
