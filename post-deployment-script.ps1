...
Set-Location $GitHubActionsRunnerPath
cmd.exe /c ".\config.cmd" --unattended --runasservice --labels ${GithubActionsRunnerLabels} --url ${GitHubActionsRunnerRepo} --token ${GitHubActionsRunnerToken}
